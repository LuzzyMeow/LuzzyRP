...
$Manifest = @(
    ...
    @{ Id = '023-sta1n-icon';         File = 'assets/js/core-utils.js';          Mode = 'contains';     Needle = '[LuzzyRP patch 023]';                   Min = 1 },
    @{ Id = '023-sta1n-novel';        File = 'novel/index.html';                 Mode = 'contains';     Needle = '[LuzzyRP patch 023]';                   Min = 1 },
