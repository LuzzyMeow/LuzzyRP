...
class MigrationWriter(
    ...
    data class Outcome(
        ...
        /** 被忽略的遗留世界书键条数（旧键在全局世界书已存在时**整份忽略**，会话 72 起）。 */
    ...
    suspend fun import(
        ...
        return store.transaction {
            ...
            Outcome(
                ...
                worldEntries = data.globalWorldEntries.size,
                legacyWorldEntriesDropped = data.legacyWorldEntriesDropped,
        ...
        store.putJson(
            ...
            kotlinx.serialization.json.JsonObject(
                mapOf(
                    ...
                    "legacyWorldEntriesDropped" to JsonPrimitive(outcome.legacyWorldEntriesDropped),
