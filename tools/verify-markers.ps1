...
$Manifest = @(
    ...
    @{ Id = '044-live-feed-call';        File = 'assets/js/app.js';               Mode = 'contains';     Needle = 'api.feed(text, assistantMessage.role';  Min = 1 },
    @{ Id = '044-live-commit-force';     File = 'assets/js/app.js';               Mode = 'contains';     Needle = 'commitLiveDelta(true);';  Min = 1 },
    @{ Id = '044-ext-feed-fn';           File = '../ext/luzzy-stream.js';         Mode = 'contains';     Needle = 'function feed(text, role)';  Min = 1 },
    @{ Id = '044-ext-live-binding';      File = '../ext/luzzy-stream.js';         Mode = 'contains';     Needle = 'if (v.live) live.el = el;';  Min = 2 },
    @{ Id = '044-ext-stale-guard';       File = '../ext/luzzy-stream.js';         Mode = 'contains';     Needle = 'if (!isLive && live.active && live.el === el)';  Min = 1 },
